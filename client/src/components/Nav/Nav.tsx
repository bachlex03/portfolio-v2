    ...
    <nav>
      <ul className={clsx('flex gap-2', SFmono.variable, styles.navList)}>
        {links.map((link, index) => {
          return (
            <li key={index} className={`${pathname === link.path && 'text-secondary border-b-2 border-secondary'} text-sm font-SFmono px-2 py-3 text-header-text hover:text-secondary select-none`}>
